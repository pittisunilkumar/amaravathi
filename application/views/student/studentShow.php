                        ...
                        <div class="widget-user-header bg-gray-light overflow-hidden">
                            <div class="widget-user-image">
                                <?php if ($sch_setting->student_photo) {
                                    ...
                                    ?>
                                    <img class="profile-user-img img-responsive img-rounded" src="<?php echo $image_url; ?>"
                            ...
                            <h5 class="widget-user-desc mb5"><?php echo $this->lang->line('admission_no'); ?> <span
                                    class="text-aqua"><?php echo $student['admission_no']; ?></span></h5>
                            <h5 class="widget-user-desc"><?php echo $this->lang->line('roll_number'); ?> <span
                                    class="text-aqua"><?php echo $student['roll_no']; ?></h5>
                        </div>
                    </div>
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            if ($student['is_active'] == 'no') {
                                ...
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('disable_reason'); ?></b> <span
                                        class="pull-right text-aqua"><?php echo $reason_data['reason'] ?></span>
                                </li>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('disable_note'); ?></b> <span
                                        class="pull-right text-aqua"><?php echo $student['dis_note'] ?></span>
                                </li>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('disable_date'); ?></b> <span
                                        class="pull-right text-aqua"><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['disable_at'])); ?></span>
                                </li>
                            <?php } ?>
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('gender'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $this->lang->line(strtolower((string) $student['gender'])); ?></a>
                            </li>
                                ...
                                <li class="list-group-item listnoback">
                                    ...
                                    <?php if (file_exists("./uploads/student_id_card/barcodes/" . $student['admission_no'] . ".png")) { ?>
                                        <a class="pull-right text-aqua">
                                            <img class="h-36"
                                                src="<?php echo $this->media_storage->getImageURL('uploads/student_id_card/barcodes/' . $student['admission_no'] . '.png'); ?>"
                            ...
                            if ($this->module_lib->hasModule('behaviour_records')) {
                                if ($this->rbac->hasPrivilege('behaviour_records_assign_incident', 'can_view')) {
                                    ...
                                    ?>
                                    <li class="list-group-item listnoback">
                                        <b><?php echo $this->lang->line('behaviour_score'); ?></b> <a
                                            class="pull-right text-aqua"><?php echo $student['total_points']; ?></a>
                                    </li>
                                    <?php
                            ...
                            <div class="box-widget widget-user-2">
                                ...
                                <div class="widget-user-header bg-gray-light overflow-hidden">
                                    ...
                                    <h4 class="widget-user-username"><a
                                            href="<?php echo site_url('student/view/' . $sibling_value->id) ?>"><?php echo $this->customlib->getFullName($sibling_value->firstname, $sibling_value->middlename, $sibling_value->lastname, $sch_setting->middlename, $sch_setting->lastname); ?></a>
                                    </h4>
                                    <h5 class="widget-user-desc mb5"><?php echo $this->lang->line('admission_no'); ?> <span
                                            class="text-aqua"><?php echo $sibling_value->admission_no; ?></span></h5>
                                    <h5 class="widget-user-desc"><?php echo $this->lang->line('roll_number'); ?> <span
                                            class="text-aqua"><?php echo $sibling_value->roll_no; ?></h5>
                                </div>
                                    ...
                                    <div class="no-padding">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <?php if ($sibling_value->rte) { ?>
                                                <li class="list-group-item listnoback">
                                                    <b><?php echo $this->lang->line('rte'); ?></b> <a
                                                        class="pull-right text-aqua"><?php echo $sibling_value->rte; ?></a>
                                                </li>
                                            <?php } ?>
                                            <li class="list-group-item listnoback">
                                                <b><?php echo $this->lang->line('gender'); ?></b> <a
                                                    class="pull-right text-aqua"><?php echo $this->lang->line(strtolower($sibling_value->gender)); ?></a>
                                            </li>
                                            <?php if ($sch_setting->student_barcode == 1) { ?>
                                                <li class="list-group-item listnoback">
                                                    <b><?php echo $this->lang->line('barcode'); ?></b>
                                                    <?php if (file_exists("./uploads/student_id_card/barcodes/" . $sibling_value->admission_no . ".png")) { ?>
                                                        <a class="pull-right text-aqua">
                                                            <img class="h-36"
                                                                src="<?php echo $this->media_storage->getImageURL('uploads/student_id_card/barcodes/' . $sibling_value->admission_no); ?>"
                                                                width="auto" height="auto" /></a>
                                                    <?php } ?>
                                                </li>
                                            <?php } ?>
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if ($this->module_lib->hasActive('examination')) { ?>
                            <li><a href="#exam" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('exam'); ?></a></li>
                        <?php } ?>
                        ...
                        <?php if ($this->module_lib->hasActive('student_attendance')) {
                            if (!$sch_setting->attendence_type) {
                                ...
                                <li class=""><a href="#attendance" data-toggle="tab"
                                        aria-expanded="true"><?php echo $this->lang->line('attendance'); ?></a>
                                </li>
                                <?php
                            }
                        }
                        ...
                        if ($this->module_lib->hasModule('behaviour_records')) {
                            if ($this->rbac->hasPrivilege('behaviour_records_assign_incident', 'can_view')) {
                                ...
                                ?>
                                <li class=""><a href="#incident" data-toggle="tab"
                                        aria-expanded="true"><?php echo $this->lang->line('student_behaviour'); ?></a></li>
                                <?php
                        ...
                        <?php if ($student["is_active"] == "yes") {
                            ...
                            if ($this->rbac->hasPrivilege('disable_student', 'can_view')) {
                                ...
                                <li class="pull-right dropdown rtl-dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a style="cursor: pointer;" onclick="send_parent_password()">
                                                <?php echo $this->lang->line('send_parent_password'); ?></a></li>
                                    </ul>
                                </li>
                                <li class="pull-right">
                                    <a style="cursor: pointer;" onclick="disable_student('<?php echo $student["id"] ?>')"
                                        class="text-red" data-toggle="tooltip" data-placement="bottom"
                            ...
                            if ($this->rbac->hasPrivilege('student_login_credential_report', 'can_view')) {
                                ?>
                                <li class="pull-right">
                                    <a href="#" class="schedule_modal text-green" data-toggle="tooltip" data-placement="bottom"
                                        title="<?php echo $this->lang->line('login_details'); ?>"><i class="fa fa-key"></i>
                                    </a>
                                </li>
                                <?php
                            }
                            ...
                            <?php if ($this->module_lib->hasActive('fees_collection')) { ?>
                                <li class="pull-right">
                                    <a href="<?php echo site_url('studentfee/addfee/' . $student["student_session_id"]) ?>"
                                        data-toggle="tooltip" data-placement="bottom"
                                        title="<?php echo $this->lang->line('collect_fees'); ?>"><b><?php echo $currency_symbol; ?>
                                        </b>
                                    </a>
                                </li>
                    ...
                    <div class="tab-content">
                                        ...
                                        <table class="table3 table-hover table-striped tmb0">
                                            <?php if ($sch_setting->father_name) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td rowspan="3"><img class="profile-user-img img-responsive img-rounded"
                                                            src="<?php
                                            ...
                                            <?php if (empty($assignstudent)) {
                                                ...
                                                foreach ($assignstudent as $assignstudent_value) {
                                                    ...
                                                    <tr class="<?php echo $pointclass; ?>">
                                                        ...
                                                        <td><?php echo $this->customlib->dateformat($assignstudent_value['created_at']) ?>
                                                        </td>
                                                        <td width="40%"> <?php echo $assignstudent_value['description'] ?></td>
                                                        <td> <?php echo $assignstudent_value['staff_name'] . ' ' . $assignstudent_value['staff_surname'] . $staff_id ?>
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-default btn-xs comments relative overflow-visible"
                                                                data-toggle="tooltip" data-placement="left"
                                                                data-original-title="<?php echo $this->lang->line('comment'); ?>"
                                                                data-record-id="<?php echo $assignstudent_value['id'] ?>">
                                                                <?php if ($assignstudent_value['totalcomments']['totalcomments'] != '0') { ?><span
                                                                        class="comment-badges"><?php echo $assignstudent_value['totalcomments']['totalcomments']; ?></span><?php } ?><i
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="fee_detail_popover" style="display: none">
                                                                    ...
                                                                    if ($fee_value->fine_amount != "") {
                                                                        ?>
                                                                        <p class="text text-danger"><?php echo $this->lang->line('fine'); ?>
                                                                        </p>
                                                                        <?php
                                                                    }
                                                                    ?>
                                            ...
                                            foreach ($student_due_feeadding as $key => $fee) {
                                                ...
                                                if (empty($student_doc)) {
                                                    ...
                                                    foreach ($student_doc as $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $this->media_storage->fileview($value['doc']); ?>
                                                            </td>
                                                            <td class="mailbox-date pull-right white-space-nowrap">

                                                                <a href="<?php echo site_url('student/download/' . $value['student_id'] . "/" . $value['id']); ?>"
                        ...
                        <div class="tab-pane" id="timelineh">
                            <div>
                                <?php if ($this->rbac->hasPrivilege('student_timeline', 'can_add')) { ?>
                                    ...
                                    <button type="button" id="myTimelineButton" class="btn btn-sm btn-primary pull-right"><i
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('student_timeline', 'can_edit')) { ?>
                                                            <span class="time">
                                                                <a data-toggle="tooltip"
                                                                    class="pull-right edit_timeline defaults-c text-right"
                                                        ...
                                                        <?php if (!empty($value["document"])) { ?>
                                                            <span class="time"><a class="defaults-c text-right"
                                                                    style="color:#0084B4" data-toggle="tooltip"
                                                                    href="<?php echo base_url() . "admin/timeline/download/" . $value["id"]; ?>"
                                                                    data-original-title="<?php echo $this->lang->line('download'); ?>"><i
                                                                        class="fa fa-download"></i></a></span>
                                                        <?php } ?>
                                                        <h3 class="timeline-header text-aqua text-break">
                            ...
                            <div class="tab-pane" id="attendance">
                                ...
                                <div>
                                    <div class="download_label">
                                        ...
                                        <?php echo $student["firstname"] . " " . $student["lastname"] . ' (' . $student["admission_no"] . ')'; ?>
                                    </div>
                        ...
                        <div class="tab-pane" id="exam">
                            ...
                            <div id="visible">
                                <center>
                                    <h4 class="hide" id="exam_student_name">
                                        <?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?>
                                ...
                                if (!empty($exam_result)) {
                                    ...
                                    <div class="dt-buttons btn-group pull-right miusDM42">
                                        <a class="btn btn-default btn-xs dt-button no_print border0" id="print"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if (!empty($exam_value->exam_result['result'])) {
                                                                        ...
                                                                        foreach ($exam_value->exam_result['result'] as $exam_result_key => $exam_result_value) {
                                                                            ...
                                                                            ?>
                                                                            <tr>
                                                                                <td><?php echo ($exam_result_value->name); ?>
                                                                                ...
                                                                                if ($exam_value->exam_type == "coll_grade_system" || $exam_value->exam_type == "school_grade_system") {
                                                                                    ?>
                                                                                    <td><?php echo findExamGrade($exam_grade, $exam_value->exam_type, $percentage_grade); ?>
                                                                                    </td>
                                                                                    <?php
                                                                                }
                                                                                if ($exam_value->exam_type == "basic_system") {
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                                                                            ...
                                                                                            <label class="label label-danger"
                                                                                                style="margin-right: 5px;"><?php echo $this->lang->line('fail') ?></label>
                                                                                            <?php
                                                                                        } else {
                                                                                            ?>
                                                                                            <label class="label label-success"
                                                                                                style="margin-right: 5px;"><?php echo $this->lang->line('pass') ?></label>
                                                                                            <?php
                                                                                        }
                                                                                        ?>
                                                                                    </td>
                                                                ...
                                                                <div class="bgtgray">
                                                                    ...
                                                                    if ($exam_value->exam_type != "gpa") {
                                                                        ...
                                                                        <div class="col-sm-3 col-lg-2 col-md-3">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('percentage') ?> : <span
                                                                                        class="description-text"><?php
                                                                        ...
                                                                        <div class="col-sm-1 pull ">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('rank'); ?> : <span
                                                                                        class="description-text"><?php echo $exam_value->rank; ?></span>
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('result') ?> :<span
                                                                        ...
                                                                        <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('grand_total'); ?> : <span
                                                                                        class="description-text"><?php echo $exam_grand_total; ?></span>
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-3 col-lg-3 col-md-3 border-right">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('total_obtain_marks'); ?> :
                                                                                    <span
                                                                                        class="description-text"><?php echo $exam_get_total; ?></span>
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('credit_hours'); ?> : <span
                                                                                        class="description-text"><?php echo $exam_credit_hour; ?></span>
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('quality_points'); ?> : <span
                                                                                        class="description-text">
                                                                                        <?php
                                                                        ...
                                                                        if ($exam_value->exam_type == "basic_system") {
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                                                                    ...
                                                                                    ?>
                                                                                            <label class="label label-success"
                                                                                                style="margin-right: 5px;"><?php echo $this->lang->line('pass') ?>
                                                                                                <label>
                                                                                                    <?php
                                                                                }
                                                                                ?>
                                                            ...
                                                            <div class="bgtgray">
                                                                ...
                                                                if ($exam_value->exam_type != "gpa") {
                                                                    ...
                                                                    <div class="col-sm-3 border-right no-print">
                                                                        <div class="description-block">
                                                                            <h5 class="description-header">
                                                                                <?php echo $this->lang->line('total_obtain_marks'); ?> : <span
                                                                                    class="description-text"><?php echo $exam_get_total; ?></span>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="bgtgray">
                                                                    ...
                                                                    if ($consolidate_exam_result_percentage) {
                                                                        ...
                                                                        <div class="col-sm-3 border-right no-print">
                                                                            <div class="description-block">
                                                                                <h5 class="description-header">
                                                                                    <?php echo $this->lang->line('division'); ?> :<span
                                                                                        class="description-text">
                                                                                        <?php
                    ...
                    <form id="formadd" method="post" class="ptt10 mb10 place-italic" enctype="multipart/form-data">
                        ...
                        <div class="clearfix">
                            <div class="d-flex justify-content-between gap-1">
                                <textarea name="comment" cols="10" rows="2"
                                    placeholder="<?php echo $this->lang->line('type_your_comment'); ?>"
                                    class="form-control resize-auto border-radius-1 max-height-40"></textarea>

                                <button type="submit" class="btn btn-send overflow-inherit max-height-40" id="submit"
                                    data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('send') ?></button>
                            </div>
                        </div>
                    </form>
                                ...
                                <div class=" col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="timeline_date"
                                            ...
                                            name="timeline_date" placeholder="" type="text" class="form-control date" />
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="labeltopmb0"><?php echo $this->lang->line('visible_to_this_person'); ?></label>
                                        <input class="valign-sub" id="visible_check" checked="checked"
                                            name="visible_check" value="yes" placeholder="" type="checkbox" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('date'); ?><small class="req">
                                                *</small></label>
                                        <input name="disable_date" id="disable_date" class="form-control date"
...
<script type="text/javascript">
    ...
    function send_password() {
        ...
        $.ajax({
            ...
            data: { student_id: student_id, username: username, password: password, contact_no: contact_no, email: email, admission_no: admission_no },
            success: function (response) {
