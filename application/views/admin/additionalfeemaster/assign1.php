        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/additionalfeemaster/assign/' . $id) ?>" method="post" class="row">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php if (!empty($resultlist)) {   ?>
                                                    <a onclick="add()" class="btn btn-primary btn-sm pull-right"> <?php echo $this->lang->line('save'); ?>
                                                </a>
                                                <?php } ?>
                                                <br/>
                                                <br/>
                                                            ...
                                                            <div class="row"> 
                                                                ...
                                                                <!-- <div class="col-md-4">
                                                                    <div class="form-group" >
                                                                        ...
                                                                        <h5><?php echo $feetype_value->id; ?></h5>
                                                                    </div>
                                                                </div> -->
