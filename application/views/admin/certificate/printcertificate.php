...
// $certificate[0]->left_header = str_replace('[admi_no]', '[admission_no]', $certificate[0]->left_header);

foreach ($students as $student) {
    $certificate_body = "";
    $certificate_body = $certificate[0]->certificate_text;
    $cerleft = "";
    $cerleft = $certificate[0]->left_header;
    ...
    foreach ($student as $std_key => $std_value) {
        ...
        if ($std_key == "admi_no"){
            $cerleft = str_replace('[admission_no]', $std_value, $cerleft);
        }
    ...
    <div class="" style="position: relative; text-align: center; font-family: 'arial';">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" style="position: absolute;top: 0; margin-left: auto;margin-right: auto;left: 0;right: 0;<?php echo "width:" . $certificate[0]->content_width . "px" ?>">
            ...
            <tr>
                ...
                <td valign="top" style="font-size: 20px; text-align:left; position: relative; <?php echo "top:" . $certificate[0]->header_height . "px" ?>"><?php echo $cerleft ?></td>
                <td valign="top" style="font-size: 20px; text-align:center; position: relative; <?php echo "top:" . $certificate[0]->header_height . "px" ?>"><?php echo $certificate[0]->center_header ?></td>
                <td valign="top" style="font-size: 20px; text-align:right; position: relative; <?php echo "top:" . $certificate[0]->header_height . "px" ?>"><?php echo $certificate[0]->right_header ?><?php echo date('d/m/Y');?></td>
            </tr>
            <tr>
                <td colspan="3" valign="top" style="position: relative; <?php echo "top:" . $certificate[0]->content_height . "px" ?>">
                    <p style="font-size: 20px; line-height: 24px; text-align:center;"><?php echo $certificate_body;
                    ?></p></td>
            </tr>
            <tr>
                <td valign="top" style="font-size: 20px; text-align:left;position: relative; <?php echo "top:" . $certificate[0]->footer_height . "px" ?>"><?php echo $certificate[0]->left_footer ?></td>
                ...
                <td valign="top" style="font-size: 20px; text-align:right;position: relative; <?php echo "top:" . $certificate[0]->footer_height . "px" ?>"><?php echo $certificate[0]->right_footer ?></td>
            </tr>
        </table>
    </div>
