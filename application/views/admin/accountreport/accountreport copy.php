                                    ...
                                    <tbody>
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo $student['receiptid']; ?></td>
                                                    <td><?php echo $student['date']; ?></td>
                                                    <td><?php echo $student['type']; ?></td>
                                                    <td><?php echo $student['status']; ?></td>
                                                    <td class="text text-center"><?php echo $student['description']; ?></td>
                                                    <td><?php if($student['status']=='debit'){echo "- ";}?><?php echo $currency_symbol; ?> <?php echo amountFormat(($student['amount'])); ?></td>
                                        ...
                                        <tr class="box box-solid total-bg">
                                            ...
                                            <td class="text text-right"></td>
                                            <td class="text text-right"></td>
                                            <td class="text text-right">Total : <?php echo $currency_symbol; ?> <?php 
                                                echo $totalamount; 
                                                // if($closeaccountblance<0){
                                                //     echo '-'.$currency_symbol . amountFormat(($closeaccountblance));
                                                // }else{
