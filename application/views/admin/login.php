    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div>
                ...
                <a href="<?php echo base_url(); ?>" class="mb-40 max-w-290-px">
...
echo $app_name[0]['name'];?></h6>
            ...
            <?php echo $this->customlib->getCSRF(); ?>
                <div class="icon-field mb-16">
                    ...
                    <input type="text" name="username" placeholder="<?php echo $this->lang->line('username'); ?>" value="<?php echo set_value('username') ?>" class="form-control h-56-px bg-neutral-50 radius-12" id="form-username">
                </div>
                ...
                <div class="position-relative mb-20">
                    <div class="icon-field">
                        ...
                        <input type="password" value="<?php echo set_value('password') ?>" name="password" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-control h-56-px bg-neutral-50 radius-12" id="your-password">

                        <!-- <input type="password" class="form-control h-56-px bg-neutral-50 radius-12" id="your-password" placeholder="<?php echo $this->lang->line('password'); ?>"> -->
                    </div>
                ...
                <div class="">
                    <div class="d-flex justify-content-between gap-2">
                        ...
                        <a href="<?php echo site_url('site/forgotpassword') ?>" class="text-primary-600 fw-medium">Forgot Password?</a>
                    </div>
                </div>
                ...
                <div class="mt-32 text-center text-sm">
                    <p class="mb-0">Student or Parent account? <a href="<?php echo site_url('site/userlogin') ?>" class="text-primary-600 fw-semibold">Users</a></p>
                </div>
