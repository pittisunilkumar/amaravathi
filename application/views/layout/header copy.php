                    ...
                    <!--<div>-->
                        <div class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('student', 'can_view')) {?>
                                ...
                                <!--<form id="header_search_form" class="navbar-form navbar-right search-form" role="search"  action="<?php echo site_url('admin/admin/search'); ?>" method="POST">-->
                                            ...
                                            <li>
                                                <div class="sstopuser">
                                                    ...
                                                    <div class="sspass">
                                                        ...
                                                        <a class="pl25" href="<?php echo base_url(); ?>admin/admin/changepass" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('change_password'); ?>"><i class="fa fa-key"></i><?php echo $this->lang->line('password'); ?></a> 
                                                        <a class="pull-right" href="<?php echo base_url(); ?>site/logout"><i class="fa fa-sign-out fa-fw"></i><?php echo $this->lang->line('logout'); ?></a>
