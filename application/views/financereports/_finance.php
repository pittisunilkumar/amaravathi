            ...
            <div class="">
                <ul class="reportlists">
                    <?php if ($this->rbac->hasPrivilege('balance_fees_statement', 'can_view')) {  ?>
						...
						<li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/reportduefees'); ?>"><a href="<?php echo site_url('financereports/reportduefees'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('total_balance_fees_statement'); ?></a></li>						
                    <?php } if ($this->rbac->hasPrivilege('balance_fees_statement', 'can_view')) {  ?>
						<li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/yearreportduefees'); ?>"><a href="<?php echo site_url('financereports/yearreportduefees'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('balance_fees_statement'); ?></a></li>						
                    ...
                    <?php } if ($this->rbac->hasPrivilege('balance_fees_statement', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/typewisebalacereport'); ?>"><a href="<?php echo base_url(); ?>financereports/typewisebalancereport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('typewisebalancereport'); ?></a></li>
                    ...
                    <?php  }  if ($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/totalstudentacademicreport'); ?>"><a href="<?php echo base_url(); ?>financereports/totalstudentacademicreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('total_balance_fees_report'); ?></a></li>
