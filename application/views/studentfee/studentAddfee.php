                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    foreach ($student_additional_fee as $key => $fee) {
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" disabled class="form-control" id="amount_discount" value="0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" disabled class="form-control" id="adding_amount_discount"
                                                value="0">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#listCollectionModal,#processing_fess_modal,#confirm-norecord,#myFeesModal,#myAdditionalFeesModal').modal({
            backdrop: 'static',
            keyboard: false,
            show: false
        });
